...
public class PatientScreenController {
    ...
    public void buttonAdd(ActionEvent event) throws JAXBException, FileNotFoundException {
        ...
        if (dupeCheck) {
            new Alert(Alert.AlertType.ERROR, "A patient with this Personal Code already exists").show();
        }
        else {
    ...
    public void savePersonDataToFile() throws JAXBException, FileNotFoundException {
        try {
            ...
            o.setPatientOrDocList(patients);

            m.marshal(o, new File("Patients.xml"));
